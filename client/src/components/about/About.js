        ...
        <section className="text-gray-600 body-font">
          ...
          <div className="container mx-auto flex px-5 py-10 md:flex-row flex-col items-center">
            <p className="w-full text-3xl text-left">
              <b>Web Team: </b> <a href="https://github.com/SageJames" onMouseOver="this.style.color='#FFF'" target={"blank"}>Alcinder Lewis</a>, <a href="https://github.com/wilsondc5" target={"blank"}>Derek Wilson</a>, <a href="https://github.com/bealkg" target={"blank"}>Katherine Beal</a>, <a href="https://github.com/loganwrichardson" target={"blank"}>Logan Richardson</a>, <a href="https://github.com/pattersonlt" target={"blank"}>Luke Patterson</a><br></br><br></br>
              <b>CLI/ API Team: </b> <a href="https://github.com/ChrisCarter01" target={"blank"}>Christine Carter</a>, <a href="https://github.com/zzMountainManzz" target={"blank"}>Jacob Villemagne</a>, <a href="https://github.com/phdavis1027" target={"blank"}>Phillip Davis</a>, <a href="https://github.com/cosmicboots" target={"blank"}>Thom Dickson</a>, <a href="https://github.com/t9605tripp" target={"blank"}>Tyler Tripp</a><br></br><br></br>
